# this script looks at variable selection for the linear models and finalizes the LM 
...
# removed bromegrass alfalfa hay ------------------------------------------
...
# determine number of acres represented  ----------------------------------
...
full.mod <- lm(yield ~ ., data = train)
back.mod <- stepAIC(full.mod, direction = "backward")
back.mod$anova # remove silt?
